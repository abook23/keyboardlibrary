...
public class KeyboardUtil {
    ...
    public TextView keyboard_view_finish;
    public ImageView keyboard_icon;
    ...
    public void initLayoutHeight(LinearLayout layoutView) {
        ...
        keyboard_icon = (ImageView) layoutView.findViewById(R.id.keyboard_icon);
